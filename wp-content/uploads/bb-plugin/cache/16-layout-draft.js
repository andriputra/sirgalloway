...
else if(this.settings.layout=='gallery'){this.gallery.resize();elements.css('visibility','visible');}}};})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'57e1d4f9810d0',layout:'grid',pagination:'numbers',postSpacing:'20',postWidth:'320',matchHeight:0});});$(window).on('load',function(){$('.fl-node-57e1d4f9810d0 .fl-post-grid').masonry('reloadItems');});})(jQuery);var wpAjaxUrl='http://localhost/ngfk/wp-admin/admin-ajax.php';var flBuilderUrl='http://localhost/ngfk/wp-content/plugins/bb-plugin/';;if(typeof FLBuilder!=='undefined'&&typeof FLBuilder._renderLayoutComplete!=='undefined')FLBuilder._renderLayoutComplete();