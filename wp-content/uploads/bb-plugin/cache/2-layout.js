...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);(function($){$(function(){var slider=$('.fl-node-57f302b1a3dd7 .fl-content-slider-wrapper').bxSlider({adaptiveHeight:true,auto:false,autoHover:true,autoControls:false,pause:5000,mode:'horizontal',speed:1000,controls:false,pager:false,video:true,onSliderLoad:function(){$('.fl-node-57f302b1a3dd7 .fl-content-slider-wrapper').addClass('fl-content-slider-loaded');},onSlideAfter:function(ele,oldIndex,newIndex){$('.fl-node-57f302b1a3dd7 .fl-slide-'+oldIndex+' iframe[src*="youtube"]').each(function(){var src=$(this).attr('src');$(this).attr('src','');$(this).attr('src',src);});}});slider.data('bxSlider',slider);$('.fl-node-57f302b1a3dd7 .slider-prev').on('click',function(e){e.preventDefault();slider.goToPrevSlide();});$('.fl-node-57f302b1a3dd7 .slider-next').on('click',function(e){e.preventDefault();slider.goToNextSlide();});});})(jQuery);var wpAjaxUrl='http://localhost/ngfk/wp-admin/admin-ajax.php';var flBuilderUrl='http://localhost/ngfk/wp-content/plugins/bb-plugin/';