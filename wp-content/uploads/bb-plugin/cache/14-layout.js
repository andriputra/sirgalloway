...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);(function($){$(function(){$('.fl-node-57e2ba0b18e1c .fl-mosaicflow-content').one('filled',function(){if('undefined'!=typeof $.waypoints){$.waypoints('refresh');}}).mosaicflow({itemSelector:'.fl-mosaicflow-item',columnClass:'fl-mosaicflow-col',minItemWidth:300});$('.fl-node-57e2ba0b18e1c .fl-mosaicflow-content, .fl-node-57e2ba0b18e1c .fl-gallery').magnificPopup({closeBtnInside:false,delegate:'.fl-photo-content a',type:'image',gallery:{enabled:true}});});})(jQuery);var wpAjaxUrl='http://localhost/ngfk/wp-admin/admin-ajax.php';var flBuilderUrl='http://localhost/ngfk/wp-content/plugins/bb-plugin/';